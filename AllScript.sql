...
VALUES 
	...
	-- Insert Statistics 1
INSERT INTO store_statistics (StatisticsID, Date, Description, Type, total_money, StoreID)
VALUES 
...
-- Debt 1
INSERT INTO Debt (DebtID, Amount, Description, Date, Status, CustomerID, StoreID)
VALUES 
...
VALUES 
	...
	-- Invoice 1
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('1', '2023-11-01T10:00:00', 500000, 20000, N'Mua gạo Jasmine Loại 1', 1, 1, '1', '1');

-- Invoice 2
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('2', '2023-11-01T11:30:00', 300000, 15000, N'Mua gạo Basmati Ấn Độ', 1, 1, '2', '1');

-- Invoice 3
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('3', '2023-11-01T14:00:00', 450000, 25000, N'Mua gạo Lứt Đỏ', 0, 0, '3', '2');

-- Invoice 4
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('4', '2023-11-02T10:00:00', 600000, 30000, N'Mua Nếp Truyền Thống', 1, 0, '4', '2');

-- Invoice 5
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('5', '2023-11-02T12:00:00', 700000, 20000, N'Mua gạo Hấp Loại 1', 1, 0, '5', '1');

-- Invoice 6
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('6', '2023-11-02T15:00:00', 500000, 15000, N'Mua gạo Jasmine Loại 2', 0, 0, '1', '1');

-- Invoice 7
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('7', '2023-11-03T09:30:00', 800000, 25000, N'Mua gạo Basmati Cao Cấp', 1, 1, '2', '1');

-- Invoice 8
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('8', '2023-11-03T11:00:00', 450000, 30000, N'Mua Nếp Thái Loại 1', 1, 0, '3', '2');

-- Invoice 9
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('9', '2023-11-03T13:45:00', 500000, 20000, N'Mua gạo Lứt Đen', 0, 1, '4', '2');

-- Invoice 10
INSERT INTO Invoice (InvoiceID, [created_at], [product_money], [ship_money], Description, Type, Status, CustomerID, StoreID)
VALUES
    ('10', '2023-11-04T10:15:00', 700000, 25000, N'Mua gạo Hấp Đặc Biệt', 1, 0, '5', '1');

	-- Invoice Detail 1
INSERT INTO Invoice_detail (invoice_detailid, Quantity, Discount, InvoiceID, ProductID)
VALUES
    ('1', 5, 10, '1', '1');
